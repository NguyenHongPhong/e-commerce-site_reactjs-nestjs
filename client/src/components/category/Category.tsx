...
export default (props: ICategoryItem) => {
    ...
    return(
        <Link to={`/categories/${slug}/${id}`} className="border-1 border-gray-500 h-40 w-32 flex flex-col items-center justify-center px-2.5">
            <img className="w-20 h-24" src={url}  />
